...
Renan generaliza o diagnóstico: PPPs e privatizações são necessárias, mas num "país da corrupção", sem fiscalização concreta, viram escândalos — cita como exemplo a empresa **EMTU/Mike** vendida em São Paulo para o grupo **Tanure**, hoje envolvida no [[eventos/Escândalo Banco Master]]. "Russo" acrescenta que "o lixo é a porta de entrada da corrupção na política" e se declara apoiador de Renan como pré-candidato.
...
- [[eventos/Escândalo Banco Master]] — mencionado no contexto de privatizações mal fiscalizadas.

## Pessoas mencionadas

- **"Russo"** — vereador de Pouso Alegre, aliado na pauta de segurança e agora também nas pautas de infraestrutura urbana.
- **"Pezão"** — figura local descrita como aliado do prefeito, apontada como responsável pelo descarte irregular.
