---
title: "Ele foi pego confessando corrupção. Vazou tudo!"
tags:
  - fonte
  - corrupção-municipal
  - segurança-pública
...
2. Monta empresa no nome de laranjas (lixo, construtora, estradas, hospitais).
3. Emendas direcionam recursos para prefeituras amigas.
4. Prefeituras licitam para as empresas do deputado.
5. Parte do dinheiro compra votos da população ("população também vende o voto").
6. Ciclo se fecha: eleitor vota no corrupto, nada muda, políticos se reelegem.
