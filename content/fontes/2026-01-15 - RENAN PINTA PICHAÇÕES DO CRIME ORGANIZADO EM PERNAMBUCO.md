...
Renan realiza o ato de pintar as pichações como gesto simbólico e manifesto: "Não podemos naturalizar que nas avenidas principais da nossa cidade temos a simbologia desses caras." A presença de demarcações do PCC é descrita como irônica: "São Paulo fica tirando sarro com o Rio de Janeiro — e está aqui exportando PCC para Paulista."

A promessa é direta: "Só confiar na gente que a gente vai fazer uma revolução nesse estado e vai banhar ele no sangue dos traficantes." E a tese mais ampla, reiterada: as facções precisam "sair da paisagem urbana de todas as cidades e estados do Brasil."

## Temas abordados

- [[temas/Segurança Pública]] — demarcações de PCC/CV/BMB em Paulista (PE); guerra de facções em condomínio habitacional; omissão do estado
