...
<a class="wiki-stat" href="/fontes"><span class="num">657</span><span class="label">Fontes</span></a>
...
<a class="wiki-card" href="/temas/Desigualdade-Regional-e-Migração-Interna"><div class="wiki-card-header"><span class="wiki-card-icon">🗺️</span><span class="wiki-card-title">Desigualdade Regional</span><span class="wiki-card-count">33 fontes</span></div><p class="wiki-card-desc">Contraste entre Santa Catarina e Maranhão; ecofazenda no Marajó como solução sustentável. Crítica ao "roubo federativo" que favorece estados mal geridos.</p></a>
