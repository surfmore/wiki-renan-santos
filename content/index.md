...
<a class="wiki-stat" href="/fontes"><span class="num">680</span><span class="label">Fontes</span></a>
...
<a class="wiki-card" href="/temas/Partido-Missão"><div class="wiki-card-header"><span class="wiki-card-icon">🏛️</span><span class="wiki-card-title">Partido Missão</span><span class="wiki-card-count">15 fontes</span></div><p class="wiki-card-desc">Aprovado pelo TSE em nov. 2025 com 547.000 membros; crescimento nas pesquisas (6% nacional, 10% em SP). Regras públicas para coalizões. Expulsão de candidato por bets.</p></a>
