...
<a class="wiki-card" href="/temas/Empobrecimento-e-Mercado-de-Trabalho"><div class="wiki-card-header"><span class="wiki-card-icon">📉</span><span class="wiki-card-title">Empobrecimento</span><span class="wiki-card-count">18 fontes</span></div><p class="wiki-card-desc">Escala 6x1, estigma do fracasso e a "geração que fracassou" por falta de oportunidades.</p></a>
